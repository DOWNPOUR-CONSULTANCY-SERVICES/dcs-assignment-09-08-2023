...
const OTPInput = () => {
    ...
    return (
        <div className='lg:w-full'>
            ...
            {showResend ? (
                <p className='text-end mt-4 tracking-[13.2] text-[10px] lg:text-[14px] lg:w-full'>
                    <span > Don’t get the code?</span>
                    <span className='text-[#000000] font-semibold'>
                        <button onClick={handleResendClick}><span >Resend</span></button>
                    </span>
                </p>
            ) : (
                <p className='text-end mt-4 tracking-[13.2] text-[10px] lg:text-[14px]'>
                    <span > Re-Send OTP in</span> <span className='text-[#000000] font-semibold'><span >{formatTime(countdown)}</span></span>
                </p>
            )}
        </div>
    );
